...
export default function Navbar() {
  ...
  const handleMouseMove = (e: MouseEvent) => {
    mouseX.set(e.pageX); // Update motion value
  };
  ...
  return (
    <div className='pointer-events-none hidden  fixed inset-x-0 bottom-10 z-30 mx-auto mb-4 md:flex origin-bottom h-full max-h-14'>
